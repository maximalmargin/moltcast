...
mkdir -p "$DEPLOY_DIR/episodes/ep004"
mkdir -p "$DEPLOY_DIR/episodes/ep005"
mkdir -p "$DEPLOY_DIR/episodes/ep006"
mkdir -p "$DEPLOY_DIR/episodes/ep007"
...
cp episodes/ep004/ep004-en.mp3 "$DEPLOY_DIR/episodes/ep004/"
cp episodes/ep005/ep005-en.mp3 "$DEPLOY_DIR/episodes/ep005/"
cp episodes/ep006/ep006-en.mp3 "$DEPLOY_DIR/episodes/ep006/"
cp episodes/ep007/ep007-en.mp3 "$DEPLOY_DIR/episodes/ep007/"
